...
export const trackAssetDownloaded = (
  ...
  assetUrl: string,
  lang: Language,
) => amplitude.track('Asset Downloaded', { assetTitle, assetUrl, lang });
...
export const trackProjectViewed = (
  ...
  projectTitle: string,
  lang: Language,
) => amplitude.track('Project Viewed', { projectSlug, projectTitle, lang });
