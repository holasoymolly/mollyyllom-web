...
const disenarNoEsCrearDesdeCero: Post = {
  ...
  titleEn: "Sometimes design is listening",
  excerpt:
...
const loQueNoSeVeEnUnaFoto: Post = {
  ...
  excerptEn: "A photo doesn't show the years of work behind a style of your own, or the concepts that changed at the last minute. But all of it is in there.",
  paragraphs: [
...
4. No se ve la mezcla de organización obsesiva y caos creativo que me acompaña en cada entrega.`,
  ...
  paragraphsEn: [
    "What you don't see in a photo also tells a story.",
    "In this image:",
    "1. You don't see the years of work it took to arrive at a style of my own.\n2. You don't see the times a concept changed at the last minute and forced me to rethink everything.\n3. You don't see the projects that made it into the world, and the ones that never saw the light.\n4. You don't see the mix of obsessive organization and creative chaos that comes with me on every delivery.",
    "But all of it is there.",
    "This time it was the eye and the sensibility of Simón Vélez, a friend and photographer, that brought the invisible part out. He didn't just take a photo, he captured a version of me I rarely get to see from the outside.",
    "I'm still open to projects that challenge my creativity and let me bring what I know: building brands that don't only look good, but that say who they really are.",
    "If you're looking to raise your visual identity with purpose and authenticity, I'd love to hear from you.",
  ],
};
...
const cuandoDigoQueHagoNfts: Post = {
  ...
  titleEn: "The NFT conversation we're not having",
  excerpt:
  ...
  excerptEn: "An uncomfortable silence and a change of subject. Standing in both the traditional creative world and the digital one gives me a point of view almost nobody has.",
  paragraphs: [
  ...
  paragraphsEn: [
    "When I say I make NFTs, I already know what's coming...",
    "An uncomfortable silence. A “what?” look. A subtle change of subject.",
    "I worked for years in agencies of different sizes. I helped train professionals more junior than me. I have a certain level of credibility in the “traditional creative world”. And I also make NFT collections on Solana; I built my own platform to launch and sell them. And I can now say part of my living comes from that.",
    "Standing in both worlds gives me a point of view almost nobody has: the conversation we need to be having about NFTs isn't the one we're having.",
    "Yes, there are real problems in the space. Scams. Generative slop. Pure speculation. I've watched colleagues lose money, collections that were scams in disguise, markets that collapsed.",
    "But yesterday, in 2026, someone cloned a card of mine from a traditional bank here. A scam that happens to millions of people every day. And it occurs to nobody to tell me: “close the account, stop using cards, the whole system is a fraud.”",
    "Writing off the entire digital art ecosystem because of its worst actors is like writing off all music because of one genre you think is “bad”. It isn't an honest argument.",
    "What almost nobody in that “traditional creative world” hears, or wants to hear:",
    "I'm a Dominican designer and artist. No gallery in New York or Paris. No fancy art school. No inherited network of collectors. For years, traditional art told me that if I wanted distribution, an audience, a living out of this, I had to ask permission from structures that were never designed for someone like me.",
    "When I released my first NFT collection, it sold to collectors in countries I've never been to. No gallery in the middle. No curator validating it. Nobody telling me my work isn't “digestible” or “commercial enough”. Just me, my work, and an infrastructure that for the first time lets me reach a global audience from the Caribbean as an independent artist.",
    "Four collections later, I have full control. I decide what I make, when, and at what price. I'm building a real community. All of it in a space the “mainstream creative world” decided to write off completely.",
    "And there's something they didn't see: the space changed. The days of collections of 10,000 generated images are over. Even the 2,000-piece ones barely work now. What works are small collections. With a concept. With a story. With something real behind them. Made by a person, not by a script, a prompt and ai.",
    "I'm not here to put the space on a pedestal. It had its boom; it can fall again. A year from now this may no longer work for me. I don't know. But right now it's working for me. It lets me illustrate freely whatever I want, with no filters and no permissions.",
    "Even if it's temporary, for artists like me it's the first distribution infrastructure that doesn't require asking permission, only love for what you do.",
    "And that's the conversation I'd like to have.",
  ],
};
...
const elTiempoYLaEnergia: Post = {
  ...
  titleEn: "Time isn't the variable, energy is",
  excerpt:
  ...
  excerptEn: "One day I solved in an hour something I'd been stuck on for weeks. That makes me think the real variable behind value isn't time.",
  paragraphs: [
    '"El tiempo es dinero..."',
  ...
  paragraphsEn: [
    "“Time is money...”",
    "It's a premise we rarely question. It governs how we charge, how we work, how we measure whether a day was “productive.” The most obvious expression of it is charging by the hour. It's the most common way to turn time into money. And it works, at least as a practical system. Charging for energy would be complicated because... how do you even measure that?",
    "But for me there's something odd about that equation. Time isn't linear when it comes to value itself.",
    "One day, sitting at my computer, I solved in an hour something I'd been stuck on for weeks... Weeks... And that hour wasn't one more hour “worked”, it was an hour where something lined up inside me. Presence, attention, drive, something clicked. That day I felt more productive than in the three previous weeks put together.",
    "And it's happened the other way round too: other times, sitting at the same screen, something I thought would take a few hours ended up taking weeks.",
    "That makes me think the real variable behind value may not be time. It's energy.",
    "Attention. Presence. State of mind. Flow. Drive.",
    "That's what produces the result. Time is only the container that energy passes through, or doesn't.",
    "And another thing: energy isn't infinite. You don't produce more of it by working more hours. It can only be redistributed. When you're stressed, worried, anxious about something, your body reassigns all of that energy to surviving the situation. And there's almost nothing left to create, to think clearly, to be here and now.",
    "It isn't stress that drains you. It's the response to stress.",
    "A calm day with 3 hours of focus can produce more than a stressed day with 12 hours of effort.",
    "If that's true, then:",
    "When I assess myself, measuring “how much did I work today” in hours is measuring the container, not the contents. I can work 10 hours and do very little. I can work 2 hours with energy and move something real.",
    "When I assess someone else, demanding “more hours” isn't demanding more results. It's demanding more “container”. And every so often, the container can be empty.",
    "And when I think about success, maybe it isn't the amount of effort. It's the quality of the energy sustained over time.",
    "I'm not saying “time is money” is a lie. In practice it still works. But it's a simplification. And sometimes it's worth seeing it for what it is: a useful gauge that doesn't capture what's really going on inside.",
    "The next time you feel it “wasn't a productive day” because you didn't work “enough hours”, ask yourself something better: “Did I put energy into what I did?” If the answer is yes, maybe the day did count, even if the traditional equation says otherwise. 😉",
  ],
};
...
const desdeElCaribeParaElMundo: Post = {
  ...
  titleEn: "From the Caribbean to the World",
  excerpt:
  ...
  excerptEn: "A few years ago, working with teams abroad from the Caribbean meant packing your bags. I stayed, and the world went remote before I ever had to leave.",
  paragraphs: [
  ...
  paragraphsEn: [
    "A few years ago, if you wanted to work with teams abroad from the Caribbean, you had to pack your bags... I stayed. And it turns out the world went remote before I ever had to leave.",
    "I design and build from Santo Domingo. The brand, the product, and the site where that product lives: the same brain that thinks through the identity carries it all the way to a working front end. This isn't theory. I've spent years working with teams and clients inside and outside the country, remotely, and my own digital ecosystem sold almost entirely to people in countries I've never been to.",
    "For a long time I believed that to play in the big leagues I had to be somewhere else. That the ceiling was geographic. And yes, there's an uncomfortable part to this... Building from here often means the local market can't always pay what the work is worth. But that doesn't make me smaller. It makes me clear about where I want to get to.",
    "Remote isn't my plan B. It's the way I already work. And what I bring to the table isn't “I do design”; it's thinking through the brand, the product and its digital presence end to end, with senior judgment and hands that can also build it in code.",
    "So I'll say it plainly and without drama: I'm opening space to collaborate with teams abroad, remotely. If you're building something and you want someone who'll design it and also carry it into a real product, from the idea to the screen, my inbox is open.",
    "Does the next generation of Caribbean talent leave... or build from here to the world? I already chose.",
  ],
};
...
const laConsistenciaNoEsSexy: Post = {
  ...
  excerptEn: "I see a lot of people go viral once and vanish six months later. Meanwhile there's something almost nobody shows: invisible discipline.",
  paragraphs: [
  ...
  paragraphsEn: [
    "Consistency isn't sexy... But it takes you far. Further than any viral moment will take you.",
    ...
    "Nothing sounds natural anymore. Nothing sounds real. Nothing sounds honest.",
    "I've been doing this for more than 17 years: design, brands, digital art. And I've watched more cycles of “hacks to grow fast” than I can count. Every so often a new promise shows up: the definitive shortcut, the “growth hack” that will change your career, the post that will make you famous and paid for it. Every so often, the same story... Fast rise, fast fall, forgotten name.",
    "Meanwhile, there's something almost nobody shows: invisible discipline.",
    "The four years I've spent learning to work with code, a little every day, while I work, while I design, while I live my life. No intensive bootcamp. No “wow” moment to share...",
    ...
    "Consistency doesn't make you viral. It doesn't make you famous overnight. It doesn't give you explosive likes.",
    ...
    "And when the hype cycle ends, and it always ends, what's left is what you built quietly, while nobody was looking.",
...
const iaParaHacernosMasCapaces: Post = {
  ...
  excerptEn: "For the first time I'm on the other side, helping design and build products powered by artificial intelligence. And it's led me to an uncomfortable question.",
  paragraphs: [
...
- Menos personas.`,
  ...
  paragraphsEn: [
    "The deeper I go into the world of language models (LLMs), the more one idea keeps going around in my head.",
    "I've been working as a designer for more than 17 years.",
    "And like many creatives, I've had to reinvent myself over and over, learn new tools, adapt to new technologies and make my way in an industry that changes constantly.",
    "Since the beginning of this year, for the first time in my life, I'm on the other side. I'm helping to design and build digital products powered by artificial intelligence.",
    ...
    "“AI won't replace people. People who know how to use AI will replace them.”",
    ...
    "And I'm not sure that should be our goal.",
    "The potential of artificial intelligence excites me deeply.",
    "I use it every day.",
    "I don't want a world without AI.",
    "What I want is a world where AI doesn't only make us more efficient, but also better human beings.",
    ...
    "Maybe the question isn't “what jobs can AI replace?”",
    "But “what human capabilities should it help us develop?”",
    "I don't have the answer... And honestly, I don't know what the future will look like either.",
    ...
    "I want to be part of a future where artificial intelligence doesn't make humanity less necessary, but more capable.",
    "Because in the end, I believe the real advance won't be building the most intelligent AI.",
    "It will be building tools that help us become more intelligent, freer, more creative and more human.",
    "And if I can contribute even a small part to building that future, I think it will have been worth it.",
  ],
};
